...
![Abandoned oil/gas wells across the U.S.](ABWELLS - COPY\saved_plots\uswells.png)
...
![Dataset](ABWELLS - COPY\saved_plots\dataset_head.png)
...
![Irradiance distribution](ABWELLS - COPY\saved_plots\consistency.png)

Figure 3: Solar irradiance consistency for gas wells. 

![U.S. solar irradiance map](ABWELLS - COPY\saved_plots\spatiallyconsistentwells.png)
...
![Model results](ABWELLS - COPY\saved_plots\model_comparison_boxplot.png)
