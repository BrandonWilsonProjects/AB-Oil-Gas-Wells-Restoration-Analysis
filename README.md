...
![Abandoned oil/gas wells across the U.S.](ABWELLS\saved_plots\uswells.png)
...
![Dataset](ABWELLS\saved_plots\saved_plots\dataset_head.png)
...
![Irradiance distribution](ABWELLS\saved_plots\consistency.png)

Figure 3: Solar irradiance consistency for gas wells. 

![U.S. solar irradiance map](ABWELLS\saved_plots\spatiallyconsistentwells.png)
...
![Model results](ABWELLS\saved_plots\model_comparison_boxplot.png)
